...
export function ActiveProductsTrendCard({ data, loading, onExpand }: Props) {
  return (
        ...
        {loading ? (
          ...
          <ResponsiveContainer width="100%" height={220}>
            <ComposedChart data={data} margin={{ top: 5, right: 5, bottom: 0, left: 0 }}>
              ...
              <Area type="monotone" dataKey="orders" name="Active Products" stroke={DS.violet} strokeWidth={2.5} fill="url(#ordersTrendPreview)" dot={false} />
